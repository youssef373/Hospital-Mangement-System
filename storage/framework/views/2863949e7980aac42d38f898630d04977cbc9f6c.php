...
<div class="container-scroller">
    ...
    <div class="main-panel" style="margin-top: 100px; margin-right: 500px;">
        ...
        <?php endif; ?>
        <form action="<?php echo e(url('send_email', $appoint->id)); ?>" enctype="multipart/form-data" method="post">
...
<?php /**PATH C:\xampp\htdocs\hospital\resources\views/admin/email_view.blade.php ENDPATH**/ ?>